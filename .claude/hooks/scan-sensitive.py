...
# Ein Wert, der per !secret hereinkommt, ist genau die richtige Form.
SECRET_REF = re.compile(r'!secret\b')
...
UNLESBAR = re.compile(r'\.(pdf|step|stp|stl|3mf|f3d|zip|bin|ttf|otf|woff2?)$', re.I)
