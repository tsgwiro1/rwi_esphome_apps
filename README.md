...
| :--- | :--- | :--- |
| [**`wp-fp1-smartblock`**](./wp-fp1-smartblock) | Intelligente, PV-optimierte Steuerung für die Heizkreispumpe (FP1) auf Basis eines XIAO ESP32-C6. Beinhaltet eine ausfallsichere Logik (NC-Verdrahtung) mit 7-stufiger Prioritäten-Kaskade, Sensor-Watchdog, lokale LDR-Displaysteuerung (ST7735) und einen DS18B20-Überhitzungsschutz. | v1.0.1 (Aktiv) |
