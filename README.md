...
| [**`ha-frontroom-info-display`**](./ha-frontroom-info-display) | Wandmontiertes 2.8"-Touchdisplay (ESP32-2432S028R) mit fünf Seiten: Übersicht, Wallbox-Detail, Ladeplan-Eingabe, Hausbatterie mit 24-h-Graph und animiertes Energieflussbild. Steuert den evcc-Lademodus und den SoC-Ladeplan direkt per REST, zusätzlich über zwei Hardware-Taster mit Status-LEDs und zwei Template-Schalter in HA. | v1.6.2 (Aktiv) |
